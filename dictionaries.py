...
# within curly braces, seperated by a comma or by using the dict
# function. Values in a dictionary can be of any data type and 
# may be repeated. Keys can't be repeated and must be 
# immutable. Dictionary keys are case sensitive, and the same name
...
# This line of code is crating a dictionary that has
# 5 key values 
...
# The pop function removes the key value fora specified key.
nums.pop(4)
print(nums, "- pop function")

# The p opitem function removes the last key value from the dictionary.
nums.popitem()
